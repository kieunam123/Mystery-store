...
if (isset($condition) && isset($_SESSION['condition'])) {
...
<div class="single-product-area">
    ...
    <div class="container">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        <div class="product-upper">
                            <img class="shop-img" width="300" height="300" alt="IMG" class="shop_thumbnail" src="<?php echo 'admin/product/uploads/' . $listImg[0]['img'] ?>" alt="<?php echo $product['name'] ?>">
                        </div>
        ...
        <div class="row">
            <?php
            if (isset($condition) && $_SESSION['condition'] != '') {
