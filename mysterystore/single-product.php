                    ...
                    <div class="row">
                                ...
                                <form action="" method="post" class="cart">
                                   <!-- <div class="quantity">
                                    ...
                                    <button class="add_to_cart_button" name="add-to-cart" value="<?php echo $productSingle['id'] ?>" type="submit">Thêm vào giỏ</button>-->
									 <a href="single-product.php?product_id=<?php echo $productSingle['id'] ?>&&add-to-cart=<?php echo $productSingle['id']?>" type="submit" class="add_to_cart_button " class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> THÊM VÀO GIỎ</a>
                        ...
                        <?php } ?> </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php if ($productSingle['status'] == 1) echo 'mới';
                                                            else echo 'cũ' ?></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td scope="row">Chất liệu</td>
                                                        <td><?php echo $productSingle['chip'] ?></td>
                                                    </tr>

                                                   <tr>
                                                        <td scope="row">Kho hàng</td>
