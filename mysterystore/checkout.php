...
if (isset($_POST['order']) && $cart != NULL) {
    ...
    if ($result == 1) {
		...
		// exit();
		 echo("<script>location.href = 'orders.php?msg=$msg';</script>");
    }
}
?>
                                ...
                                <div class="col-1">
                                    <div class="woocommerce-billing-fields">
                                        ...
                                        <p id="billing_first_name_field" class="form-row form-row-first validate-required">
                                            <label class="" for="billing_first_name" class="required">Họ Tên *</abbr>
                                            </label>
                                            <input type="text" value="<?php echo $user['full_name'] ?>" placeholder="" id="billing_first_name" name="ten" class="input-text">
                                        </p>

                                        <div class="clear"></div>
                                        <p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
                                            <label class="" for="billing_address_1" class="required">Địa chỉ *
                                            </label>
                                            <input type="text" placeholder="Số nhà, Tên đường, quận, huyện,.. " id="billing_address_1" name="extra_address" class="input-text ">
                                        </p>
										
                                        <p id="billing_country_field" class="form-row form-row-wide address-field update_totals_on_change validate-required woocommerce-validated">
                                            <label class="" for="billing_country">Thành phố
                                            </label>
                                            <input type="text" value="<?php echo $user['city'] ?>" placeholder="Tỉnh/Thành Phố" name="city">
                                        </p>									
                                        ...
                                        <p id="billing_phone_field" class="form-row form-row-last validate-required validate-phone">
                                            <label class="" for="billing_phone" class="required">Số Điện Thoại *
                                            </label>
                                            <input type="text" value="<?php echo $user['phone'] ?>" placeholder="" id="billing_phone" name="time" class="input-text ">
                                        </p>

                                        <p id="billing_email_field" class="form-row form-row-first validate-required validate-email">
                                            <label class="" for="billing_email">Email
                                            </label>
                                            <input type="email" value="<?php echo $user['email'] ?>" placeholder="exaple@abc.com" id="billing_email" name="email" class="input-text ">
                                        </p>
