    ...
    <div class="container">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <textarea name="short_desc" cols="90" rows="10" style="white-space: pre-line;" wrap="hard" ><?php echo $obj['short_desc'] ?></textarea>
                    <!-- <textarea cols="90" rows="10" value="<?php echo $obj['short_desc'] ?>" name="short_desc" required></textarea>-->
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="number" name="status" placeholder="1 là mới" required>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="number" value="<?php echo $obj['quantity_product'] ?>" name="quantity_product" required>
                </div>
            </div>
            <!--<div class="form-group row">
            ...
            <div class="form-group row">
                <label for="staticEmail" class="col-sm-2 col-form-label">Số đo</label>
                <div class="col-sm-10">
         ...
         <!--   <h3>Đặc Điểm Nổi Bật</h3>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    <img height="300px" width="400px" src="<?php echo 'admin/product/uploads/' . $contents[0]['img'] ?>" alt="">
